...
router.put('/:spotId/images', requireAuth, async (req, res) => {
  ...
  if (!spotImage) {
    return res
      .status(404)
      .json({
        "message": "Spot images couldn't be found",
        "statusCode": 404
      })
  };
  // console.log("THE SPOT", spot)
  // console.log("THE SPOT IMaGES", spotImage)

  // if(spotImage.length) {
  //   for (let i = 0; i < SpotImages.length; i++) {
  //     spot.SpotImages[0] = SpotImages[0]
  //     spot.SpotImages[1] = SpotImages[1]
  //     spot.SpotImages[2] = SpotImages[2]
  //     spot.SpotImages[3] = SpotImages[3]
  //     spot.SpotImages[4] = SpotImages[4]
  //   }
  // }
  spotImage.url = url;
  spot.save();
  ...
  // console.log('BACKEND SPOT IMAGES ====', spotImage)
})
